...
public class Contactanos extends AppCompatActivity {
    ...
    private EditText cnom, cmail, cmensaje;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnom= findViewById(R.id.nom);
        cmail= findViewById(R.id.email);
        ...
        benviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:" + cnom.getText().toString()));
                intent.putExtra(Intent.EXTRA_SUBJECT,cmail.getText().toString());
